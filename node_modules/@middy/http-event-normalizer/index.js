...
const httpEventNormalizerMiddleware = (opts = {}) => {
  ...
  const httpEventNormalizerMiddlewareBefore = async request => {
    ...
    switch (options.payloadFormatVersion) {
      ...
      case 2:
        isHttpEvent = Object.prototype.hasOwnProperty.call(event, 'requestContext') && Object.prototype.hasOwnProperty.call(event.requestContext, 'http') && Object.prototype.hasOwnProperty.call(event.requestContext.http, 'method');
        break;
