...
const httpErrorHandlerMiddleware = (opts = {}) => {
  ...
  const httpErrorHandlerMiddlewareOnError = async request => {
    ...
    if ((_request$error5 = request.error) !== null && _request$error5 !== void 0 && _request$error5.expose) {
      var _request$error6, _request$error7, _request$response;
      ...
      request.response.body = jsonSafeParse((_request$error7 = request.error) === null || _request$error7 === void 0 ? void 0 : _request$error7.message);
      request.response.headers['Content-Type'] = typeof ((_request$response = request.response) === null || _request$response === void 0 ? void 0 : _request$response.body) === 'string' ? 'plain/text' : 'application/json';
